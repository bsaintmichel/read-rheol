...
antonpaar_mapper_fr = {'Temps' : 'time_global', 'Intervalle Temps' : 'time', 'Gradient de Cisaillement' : 'shearrate', 'Contrainte de Cisaillement' : 'stress', 'Déformation de Cisaillement' : 'strain', 'Fréquence' : 'freq', 
